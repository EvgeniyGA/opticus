...
::if exist "C:\arm\xpack-arm-none-eabi-gcc\bin\arm-none-eabi-gdb-py3.exe" (
set gdbclient="C:\arm\xpack-arm-none-eabi-gcc-14.2.1\bin\arm-none-eabi-gdb-py3.exe"
::) 
...
:: JLinkGDBServerCL.exe -device STM32F407VG -if swd -port 2331 -swoport 2332 -telnetport 2333 -select usb=59201806 -nogui -noir -novd -nosinglerun -silent -nohalt
...
::        && (JLink.exe -device STM32F407VG -if SWD -speed 4000 -NoGui 1 -USB %%n -CommandFile %~dp0flash.jlink) 1> nul
::    call :ExitOnError
::)

((echo r & echo h & echo g & echo q) > %~dp0flash.jlink) ^
    && (JLink.exe -device STM32F407VG -if SWD -speed 4000 -NoGui 1 -USB 59201806 -CommandFile %~dp0flash.jlink) 1> nul
call :ExitOnError
